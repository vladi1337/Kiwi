...
// todo: this function is not used anywhere but some of the icons need to be
// rendered when rendering each row
...
// todo: these should be the historical priorities and category
